...
iptables -t mangle -A OUTPUT -p all -o eno1 -d 192.168.150.0/24 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\Administrator -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\krbtgt -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\wkleung -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\citrixtest -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\hmmeng.cuhk -o eno1 -j ACCEPT
...
# tc for hccltbrnet\\njzheng.cuhk:6
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\njzheng.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\jcli.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\xyliu.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\mwmak.polyu -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\xqke.polyu -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\ssxu.polyu -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\bmak.ust -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\cfhuang.ust -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\mxj.ust -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\khwong.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\hhlfung.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\tkwok.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\vctmok.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\pwong.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\jeanwoowong.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\kelvintsoi.cuhk -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\peter -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\katy -o eno1 -j ACCEPT
...
# whitelist tcp package without any payloads
iptables -t mangle -A OUTPUT -p tcp -m u32 ! --u32 "0>>22&0x3C@12>>26&0x3C@0=0:4294967295" -m owner --uid-owner hccltbrnet\\cherry.lui.bdda.cuhk -o eno1 -j ACCEPT
