...
/sbin/tc class add dev eno1 parent 1:0 classid 1:1 htb rate 500000kbps ceil 500000kbps
...
/sbin/tc class add dev eno1 parent 1:0 classid 1:26 htb rate 10kbps ceil 10kbps

# tc for hccltbrnet\\helper02:27
/sbin/tc class add dev eno1 parent 1:0 classid 1:27 htb rate 10kbps ceil 10kbps

# tc for hccltbrnet\\luhui.cuhk:28
/sbin/tc class add dev eno1 parent 1:0 classid 1:28 htb rate 10kbps ceil 10kbps

# tc for hccltbrnet\\mlwu.cuhk:29
/sbin/tc class add dev eno1 parent 1:0 classid 1:29 htb rate 10kbps ceil 10kbps

# tc for hccltbrnet\\kzhang.cuhk:30
/sbin/tc class add dev eno1 parent 1:0 classid 1:30 htb rate 10kbps ceil 10kbps

# tc for hccltbrnet\\gnli.cuhk:31
/sbin/tc class add dev eno1 parent 1:0 classid 1:31 htb rate 10kbps ceil 10kbps

# tc for hccltbrnet\\zye.cuhk:32
/sbin/tc class add dev eno1 parent 1:0 classid 1:32 htb rate 10kbps ceil 10kbps
